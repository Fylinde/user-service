...
class SellerBase(BaseModel):
    ...
    email: EmailStr
    phoneNumber: Optional[str]  # Added phoneNumber
...
class SellerCreate(SellerBase):
    ...
    password: str
    phoneNumber: Optional[str] = None  # Add phone number for user registration
...
class SellerRead(BaseModel):
    ...
    full_name: str  # Updated from username to full_name
    email: EmailStr
    phoneNumber: Optional[str] = None  # Added phoneNumber
...
class SellerWithDetails(SellerRead):
...
class SellerResponse(BaseModel):
    ...
    email: EmailStr
    phoneNumber: Optional[str] = None  # Add phone number in response
    is_active: bool
    is_admin: bool
