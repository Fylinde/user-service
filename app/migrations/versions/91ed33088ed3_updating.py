...
def upgrade():
    ...
    op.create_table('groups',
        ...
        checkfirst=True  # Prevents the table from being recreated if it already exists
    )
    ...
    # Check if the 'addresses' table exists before creating it
    ...
    # Check if the 'customer_events' table exists before creating it
    ...
    # Check if the 'customer_notes' table exists before creating it
    ...
    # Check if the 'group_permissions' table exists before creating it
    ...
    # Check if the 'staff_notification_recipients' table exists before creating it
    ...
    # Check if the 'user_groups' table exists before creating it
    ...
    op.add_column('users', sa.Column('middle_name', sa.String(length=128), nullable=True))  # Optional middle name
