...
def upgrade():
    ...
    op.add_column('sellers', sa.Column('ai_performance_score', sa.Integer(), nullable=True))
    op.add_column('sellers', sa.Column('marketplace_visibility', sa.Boolean(), nullable=True))
    op.add_column('sellers', sa.Column('stock_alert_opt_in', sa.Boolean(), nullable=True))
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('sellers', 'stock_alert_opt_in')
    op.drop_column('sellers', 'marketplace_visibility')
    op.drop_column('sellers', 'ai_performance_score')
